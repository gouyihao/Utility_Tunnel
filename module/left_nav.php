<?php
	$php_file=substr($_SERVER['PHP_SELF'],strrpos($_SERVER['PHP_SELF'],'/')+1);
?>
<div style="width:15%;float:left;background-color:#14567E;height:100%" id="list">
		  <div id="divlist" class="list-group" style="border-radius:0;">
			<a href="index.php" class="list-group-item list-group-item-action <?php if ($php_file == "index.php") { ?>nav-left-active<? } else { ?>nav-left<?php } ?>" style="border:0">
				<font color="#FFFFFF">
			...
			<a href="list.php" class="list-group-item list-group-item-action <?php if ($php_file == "list.php") { ?>nav-left-active<? } else { ?>nav-left<?php } ?>" style="border:0"><font color="#FFFFFF">
			...
			<a href="threshold.php" class="list-group-item list-group-item-action <?php if ($php_file == "threshold.php") { ?>nav-left-active<? } else { ?>nav-left<?php } ?>" style="border:0"><font color="#FFFFFF">
			...
			<a href="control.php" class="list-group-item list-group-item-action <?php if ($php_file == "control.php") { ?>nav-left-active<? } else { ?>nav-left<?php } ?>" style="border:0"><font color="#FFFFFF">
			...
			<a href="video.php" class="list-group-item list-group-item-action <?php if ($php_file == "video.php") { ?>nav-left-active<? } else { ?>nav-left<?php } ?>" style="border:0"><font color="#FFFFFF">
			...
			<a href="#" class="list-group-item list-group-item-action disabled" tabindex="-1" aria-disabled="true"  style="border:0;background:#14567E"><font>
